...
namespace RecipeManager.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(BLL.ViewModels.Identity.LoginViewModel model, string returnUrl)
        {
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Register(BLL.ViewModels.Identity.RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
